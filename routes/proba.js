          ...
          <script>
            ...
            function renderTable(data) {
              ...
              data.forEach(livro => {
                ...
                mainRow.onclick = () => toggleRow(livro.id);
                    ...
                    <div class="expanded-content">
                      <div class="details-grid">
                        ...
                        <div class="detail-item">
                          ...
                          <span>\${livro.tituloOriginal || 'N/A'}</span>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Idioma original:</span>
                          <span>\${livro.idiomaOriginal || 'N/A'}</span>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Electrónico:</span>
                          <span>\${livro.Electronico ? 'Sí' : 'No'}</span>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Parte de serie:</span>
                          <span>\${livro.SomSerie ? 'Sí' : 'No'}</span>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Premios:</span>
                          <span>\${livro.Premios || 'Ninguno'}</span>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Descripción:</span>
                          <p>\${livro.Descricom || 'No disponible'}</p>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Comentario:</span>
                          <p>\${livro.Comentario || 'No disponible'}</p>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Cantidad en serie:</span>
                          <span>\${livro.quantidadeSerie}</span>
                        </div>
                        <div class="detail-item">
                          <span class="detail-label">Relecturas:</span>
                          <span>\${livro.quantidadeRelecturas}</span>
                        </div>
                      </div>
                    </div>
                  </td>
