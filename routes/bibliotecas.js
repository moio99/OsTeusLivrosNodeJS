...
router.get('/', async function(req, res, next) {
  try {
    ...
    res.json(await bibliotecas.getBibliotecas());
  } catch (err) {
 ...
 */
 router.get('/BibliotecasCosLivros', async function(req, res, next) {
  try {
    // res.json(await programmingLanguages.getMultiple(req.query.page));
    res.json(await bibliotecas.getBibliotecasCosLivros());
  } catch (err) {
 ...
 */
 router.get('/Biblioteca', async function(req, res, next) {
  try {
    // res.json(await programmingLanguages.getMultiple(req.query.page));
    res.json(await bibliotecas.getBiblioteca(req.query.id));
  } catch (err) {
...
router.post('/Biblioteca', async function(req, res, next) {
  try {
    res.json(await bibliotecas.postBiblioteca(req.body));
  } catch (err) {
...
router.put('/Biblioteca', async function(req, res, next) {
  try {
    res.json(await bibliotecas.putBiblioteca(req.body));
  } catch (err) {
...
router.delete('/Biblioteca', async function(req, res, next) {
  try {
    if (req.query.id != undefined)
      res.json(await bibliotecas.borrarBiblioteca(req.query.id));
    else
